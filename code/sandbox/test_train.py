...
# print(my_dataset[0])
# print(my_dataset[0].scale0_cluster_map)
# print(my_dataset[0].scale0_sample_index)

def create_poly(points, lines):
    poly = pv.PolyData()
    poly.points = points
    poly.lines = np.hstack((np.repeat(2,len(lines))[:,np.newaxis], lines)) 
    return poly 

# print(my_dataset[0])
# print(my_dataset[0].scale1_sample_index)
# print(my_dataset[0].scale1_edge_index)
# print(my_dataset[0].scale2_sample_index)
# print(my_dataset[0].scale2_edge_index)

# print(torch.max(my_dataset[0].scale1_edge_index))

# poly_s0 = create_poly(np.array(my_dataset[0].pos),np.array(my_dataset[0].scale0_edge_index).T)
# poly_s0.save('./result/data0_poly_s0.vtp')
# poly_s1 = create_poly(np.array(my_dataset[0].pos[my_dataset[0].scale1_sample_index]),np.array(my_dataset[0].scale1_edge_index).T)
# poly_s1.save('./result/data0_poly_s1.vtp')
# poly_s2 = create_poly(np.array(my_dataset[0].pos[my_dataset[0].scale1_sample_index[my_dataset[0].scale2_sample_index]]),np.array(my_dataset[0].scale2_edge_index).T)
# poly_s2.save('./result/data0_poly_s2.vtp')
