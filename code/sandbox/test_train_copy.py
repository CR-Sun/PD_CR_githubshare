...
print('allmax, allmin:',allmax, allmin) # tensor([129561.0469,   1055.8834]) tensor([9.2764e+04, 5.5870e-01]
# Data(x=[10103, 3], y=[10103, 2], pos=[10103, 3], norm=[10103, 3], stmdist=[10103, 1], face=[3, 19996], edge_index=[2, 60212], featr2=[10103, 3, 3, 3], featr3=[10103, 3, 3, 3], featr4=[10103, 3, 3, 3], featr5=[10103, 3, 3, 3], featr6=[10103, 3, 3, 3], featr7=[10103, 3, 3, 3])
...
data = torch.load('../../data/vertex/processed/data_{:d}.pt'.format(0))
...
def myTransform(data):
    ...
    hsc = HeatSamplingCluster([0.8, 0.3, 0.1], [0.0014, 0.0028, 0.007], loop=True)
...
print(my_dataset[0].scale0_cluster_map.size())
print(my_dataset[0].scale1_cluster_map.size())
print(my_dataset[0].scale2_cluster_map.size())
np.save('./result/scale0_id.npy',np.array(my_dataset[0].scale0_cluster_map))
np.save('./result/scale1_id.npy',np.array(my_dataset[0].scale1_cluster_map))
np.save('./result/scale2_id.npy',np.array(my_dataset[0].scale2_cluster_map))

# print(my_dataset[0].scale2_edge_index.size())
# print(torch.max(my_dataset[0].scale2_edge_index))